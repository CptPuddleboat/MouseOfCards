...
public class TileScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // Once that's done, if I should be added to the array on awake, do it. I have also been explored
    ...
    public bool Explore()
    {
        if(explored == false)
        {
            Color exploredTile = new Color(1f, 1f, 1f, 1f);
            suitSprite.color = exploredTile;
            pathSprite.color = exploredTile;
            backSprite.color = exploredTile;
            explored = true;
            return true;
        }
        else
